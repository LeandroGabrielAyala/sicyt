...
class RubroPolicy
{
    ...
    {
        return $user->can('force_delete_rubro');
    }
    ...
    {
        return $user->can('force_delete_any_rubro');
    }
    ...
    {
        return $user->can('restore_any_rubro');
    }
    ...
    {
        return $user->can('replicate_rubro');
    }
